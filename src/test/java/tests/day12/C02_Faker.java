...
public class C02_Faker extends TestBase {
    ...
    public void test(){
        ...
        Assert.assertTrue(kadın.isSelected());
        ...
        Assert.assertFalse(özel.isSelected());
        //Sayfayi kapatin

    }

}
//arkadaslar son trick'i birakiyorum: Dinamik olan yani sayfa her yenilendiginde degisen id gibi elementleri
// contains ile locate edebilirsiniz.
