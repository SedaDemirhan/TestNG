...
public class C01_Alerts {
   ...
   // Sag click yapamiyorsak alert bir JS Allert'dur ve switchTo() kullanilarak handle edilebilir
    ...
    public void acceptAlert(){
        ...
        assertEquals(actualResult,expectedResult,"sonuc yazısı istenen ile aynı değil");
    ...
    public void dismissAlert(){
        ...
        assertFalse(actualResult.contains(istenmeyenKelime),"result yazısı istenmyen kelimeyi içerir");
