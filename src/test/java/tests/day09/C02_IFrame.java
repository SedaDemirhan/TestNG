    ...
    public void setup(){
     ...
     public void ifarmeTest(){
        ...
        //○ “An IFrame containing….” textinin erisilebilir oldugunu test edin ve  konsolda  yazdirin.
         ...
         Assert.assertTrue(baslikYaziElementi.isEnabled(),"başlık yazısı erişilebilir değil");
        ...
        //○ Text Box’a “Merhaba Dunya!” yazin.
         ...
         gecis yaptigimiz iFrame'den geri donmeliyiz...... bunun için 2 seçenek var
         parentFrame()-----> bir üst level'la geçeriz
         defaultContent()---->en üstteki frame,direk anasayfaya geçer */
